...
interface PdfRow { id: number; title: string; description: string; url: string; category: string; required_plan: string; release_month: number; sort_order: number; status: string; created_at: string; }
function AdminPdfs() {
  ...
  return (
    <AdminCrudPage<PdfRow>
      ...
      description="Manage downloadable PDFs and monthly notes library."
      ...
      defaultForm={{ required_plan: "Premium", status: "draft" } as Partial<PdfRow>}
      formFields={[
