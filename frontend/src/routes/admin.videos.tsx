...
interface VideoRow { id: number; title: string; description: string; url: string; thumbnail: string; category: string; required_plan: string; duration: string; release_month: number; sort_order: number; status: string; created_at: string; }
function AdminVideos() {
  ...
  return (
    <AdminCrudPage<VideoRow>
      title="Videos CMS"
      description="Manage learning video library and monthly releases."
      ...
      defaultForm={{ required_plan: "Premium", status: "draft" } as Partial<VideoRow>}
      formFields={[
